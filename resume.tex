...
\begin{itemize}
\item \textbf{Maldonado Homelab Platform} \\

For 5+ years, I have designed, built, and maintained a production-style homelab environment focused on infrastructure-as-code, container orchestration, and self-hosted services. The platform emphasizes automation, observability, segmentation, and reduced dependency on third-party cloud SaaS platforms. 
...
The environment is built using a layered architecture model:
    ...
    \begin{itemize}
        ...
        \item \textbf{Infrastructure as Code:} Terraform (OpenTofu), Ansible
        \item \textbf{CI/CD \& GitOps:} GitLab CE, GitLab Runners
        \item \textbf{Virtualization:} Proxmox VE (KVM, LXC)
        \item \textbf{Networking:} Cisco NX-OS/IOS/ASA, TP-Link Omada SDN (VLAN/ACL design)
        \item \textbf{DNS \& PKI Automation:} BIND9, Pi-hole, Cloudflare API, Caddy
